...
if (!class_exists('MbarePricesSchema')) {
    class MbarePricesSchema extends Abstract_Schema_Piece
    {
        /**
            ...
            try {
                ...
                if (array_key_exists("prices", $this->api_data) && is_array($this->api_data["prices"])) {
                    foreach ($this->api_data["prices"]["produce_prices"] as $mbare_price) {
                        ...
                        $valid_until = date('Y-m-d', strtotime($this->api_data["prices"]["Date"] . ' + 7 days'));
                        ...
                        $prices_schema = [
                            ...
                            "itemOffered" => [
                                ...
                                "offeredQuantity" => [
                                    ...
                                    "value" => $quantity_and_unit[0],
                                    "unitCode" => $quantity_and_unit[1],
                                ], "aggregateRating" => [
